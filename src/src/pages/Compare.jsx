...
export default function Compare() {
  ...
  if (selectedCars.length === 0) {
    return (
      <>
        <Helmet>
          <title>Compare EVs — Enerlytics</title>
          <meta name="description" content="Compare up to 4 electric vehicles side-by-side with detailed specifications and performance metrics." />
        </Helmet>
        <Nav />
  ...
  const specs = [
    ...
    { category: 'Winter & Thermal', items: ['has_heat_pump', 'has_battery_preconditioning', 'winter_range_km', 'winter_range_pct', 'platform_voltage'] },
    { category: 'Charging', items: ['dc_fast_charge_kw', 'ac_charge_kw', 'charge_time_10_80_min'] },
    { category: 'Battery Technology', items: ['battery_chemistry', 'battery_warranty_years', 'battery_warranty_km'] },
  ...
  const specLabels = {
    ...
    has_heat_pump: 'Heat Pump', has_battery_preconditioning: 'Preconditioning', winter_range_km: 'Winter Range (km)', winter_range_pct: 'Winter Range (%)', platform_voltage: 'Platform Voltage (V)',
    dc_fast_charge_kw: 'DC Fast Charge (kW)', ac_charge_kw: 'AC Charge (kW)', charge_time_10_80_min: '10-80% Time (min)',
    battery_chemistry: 'Chemistry', battery_warranty_years: 'Warranty (years)', battery_warranty_km: 'Warranty (km)',
  ...
  const findBestValue = (spec) => {
    ...
    const maximize = ['power_kw', 'power_hp', 'wltp_range_km', 'real_range_km', 'battery_kwh', 'dc_fast_charge_kw', 'ac_charge_kw', 'charge_time_10_80_min', 'total_cargo_l', 'km_per_eur', 'winter_range_km', 'winter_range_pct', 'platform_voltage', 'battery_warranty_years'];
    const minimize = ['consumption_wh_km', 'price_eur', 'co2_production_t', 'co2_lifetime_t', 'battery_warranty_km'];
