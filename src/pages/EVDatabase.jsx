...
import { getCarImageUrl, getImaginFallbackUrl } from '../lib/carImage';
                  ...
                  <div key={car.id} className="ev-card">
                    <div className="card-image">
                      <img
                        ...
                        loading="lazy"
                        onError={(e) => {
                          const fallback = getImaginFallbackUrl(car.brand, car.model);
                      ...
                      />
                      <div className="image-placeholder fallback" style={{display:'none'}}>
