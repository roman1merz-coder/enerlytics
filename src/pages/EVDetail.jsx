...
import { getCarImageUrl, getImaginFallbackUrl, getGalleryImageUrls } from '../lib/carImage';
...
export default function EVDetail() {
  ...
  // Load gallery images by probing which ones exist
  useEffect(() => {
    if (!car) return;
    const urls = getGalleryImageUrls(car.brand, car.model);
    const loaded = [];
    let stopped = false;
    ...
    // Check images sequentially — stop at first 404
    (async () => {
          ...
          <div className="detail-hero">
            <div className="hero-image-placeholder">
              <img
                ...
                onError={(e) => {
                  const fallback = getImaginFallbackUrl(car.brand, car.model, { width: 800 });
            ...
            <div className="detail-gallery">
              ...
              <div className="gallery-grid">
                {galleryImages.map((url, idx) => (
                  ...
                  >
                    <img src={url} alt={`${car.brand} ${car.model} - ${idx + 1}`} loading="lazy" />
                  </div>
                ))}
              </div>
            </div>
